        ...
        <div className="row gy-4 text-center text-md-start">
          <div className="col-12 col-md-4">
            ...
            <p className="text-muted small mt-2">
              Développeur d'applications et de solutions web. Passionné par
              l'automatisation et le code propre.
            </p>
          </div>
          ...
          <div className="col-12 col-md-4 text-center">
            ...
            <ul className="list-unstyled d-flex justify-content-center gap-3 m-0">
              <li>
                <a
                  href="#Home"
                  className="text-muted text-decoration-none text-hover-primary"
                >
                  Accueil
                </a>
              </li>
          ...
          <div className="col-12 col-md-4 text-center text-md-end">
            ...
            <div className="d-flex justify-content-center justify-content-md-end gap-3 mb-3">
              <a
                href="https://github.com/SylvioRm"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/sylvio-ramiandrisoa-751a21363"
                target="_blank"
                rel="noopener noreferrer"
