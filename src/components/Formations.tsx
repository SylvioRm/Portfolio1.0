...
const formations = [
  {
    ...
    period: "2024 - actuel",
    description:
      "Actuellement, étudiant en troisième année en Informatique de Gestion",
    icon: (
      <GraduationCap
        size={30}
  ...
  return (
    <>
      <div className="py-3" id="formations">
        <Title color="dark">Formations</Title>
        <div className="d-flex flex-column-reverse flex-lg-row justify-content-center align-items-center mb-2">
          <div className="d-flex flex-wrap gap-4 justify-content-center mt-4 mt-lg-0 col-lg-4">
            {skills.map((skill) => (
              ...
              >
                <div
                  className="d-flex justify-content-center align-items-center border border-2 border-primary rounded-circle p-2"
                  style={{ width: "60px", height: "60px" }}
                >
                  <img
                    src={skill.image}
                    alt={skill.name}
                    className="object-cover rounded-circle w-100 h-100"
                  />
                </div>
